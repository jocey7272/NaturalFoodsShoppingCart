 ...
 * CSC480
 * Here we get a list of all products in the vegetable category.
 */
include 'controller.php';
?>
<title>Natural Foods: Vegetables</title>
<meta charset="UTF-8">
...
<p class="page-purpose">Vegetables</p>
<div class="product-grid">
        <?php
        $vegarr = $theDBA->getAllVegetables();
