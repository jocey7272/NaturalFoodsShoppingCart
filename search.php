 ...
 * CSC480
 * Search page to search for items in the database based upon product name.
 */
include 'controller.php';
?>
<title>Natural Foods: Search</title>
<meta charset="UTF-8">
...
<p class="page-purpose">Search Catalog</p>
...
<div id="product-grid" class="product-grid">
        <?php
        $productarr = $theDBA->getAllProducts();
...
function searchProducts(query) {
    fetch(`controller.php?query=${encodeURIComponent(query)}`)
