 ...
 * CSC480
 * Here we get a list of all products in the nut category.
 */
include 'controller.php';
?>
<title>Natural Foods: Nuts</title>
<meta charset="UTF-8">
...
<p class="page-purpose">Nuts</p>
<div class="product-grid">
        <?php
        $nutarr = $theDBA->getAllNuts();
